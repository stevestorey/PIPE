...
import pipe.actions.ExitAction;
import pipe.actions.GridAction;
import pipe.actions.GroupTransitionsAction;
import pipe.actions.GuiAction;
import pipe.actions.SpecifyTokenAction;
import pipe.actions.TypeAction;
import pipe.actions.UnfoldAction;
import pipe.actions.UngroupTransitionsAction;
import pipe.actions.ZoomAction;
import pipe.actions.animate.AnimateAction;
import pipe.actions.animate.MultiRandomAnimateAction;
import pipe.actions.animate.RandomAnimateAction;
import pipe.actions.animate.StepBackwardAction;
import pipe.actions.animate.StepForwardAction;
import pipe.actions.animate.ToggleAnimateAction;
import pipe.actions.edit.CopyAction;
import pipe.actions.edit.CutAction;
import pipe.actions.edit.PasteAction;
import pipe.actions.edit.RedoAction;
import pipe.actions.edit.UndoAction;
import pipe.actions.file.CloseAction;
import pipe.actions.file.CreateAction;
import pipe.actions.file.ExportPNGAction;
import pipe.actions.file.ExportPSAction;
import pipe.actions.file.ExportTNAction;
import pipe.actions.file.FileAction;
import pipe.actions.file.ImportAction;
import pipe.actions.file.OpenAction;
import pipe.actions.file.PrintAction;
import pipe.actions.file.SaveAction;
import pipe.actions.file.SaveAsAction;
import pipe.actions.type.AddTokenAction;
import pipe.actions.type.AnnotationAction;
import pipe.actions.type.ArcAction;
import pipe.actions.type.DeleteTokenAction;
import pipe.actions.type.DragAction;
import pipe.actions.type.ImmediateTransitionAction;
import pipe.actions.type.PlaceAction;
import pipe.actions.type.RateAction;
import pipe.actions.type.SelectAction;
import pipe.actions.type.TimedTransitionAction;
